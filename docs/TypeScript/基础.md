...
TypeScript 中的接口是一个非常灵活的概念，除了可用于[对类的一部分行为进行抽象](./index.md)以外，也常用于对「对象的形状（Shape）」进行描述。
...
关于声明合并的更多用法，可以查看[声明合并](./index.md)章节。
