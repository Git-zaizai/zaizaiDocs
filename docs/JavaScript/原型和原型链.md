...
![prototype](https://notes.fe-mm.com/assets/prototype.a3e81543.jpg)
...
![constructor](https://notes.fe-mm.com/assets/constructor.7e04c30d.jpg)
...
- 设置当前对象的原型对象 + [Object.setPrototypeOf](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Object/setPrototypeOf) + [Reflect.setPrototypeOf](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Reflect/setPrototypeOf)
:::
...
![proto](https://notes.fe-mm.com/assets/proto__.0edbfd14.jpg)

## 原型链

每个对象都拥有一个原型对象，通过 `__proto__` 指针指向上一个原型 ，并从中继承方法和属性，同时原型对象也可能拥有原型，这样一层一层，最终指向 `null`。这个**链式结构**被称为**原型链**。

![prototype-chain](https://notes.fe-mm.com/assets/prototype-chain.76de28ac.jpg)
...
![prototypes](https://notes.fe-mm.com/assets/prototypes-1.9e629aa1.jpg)
